...
set_cover_title(
    ...
    [
        ...
        "Comparison of policy wording 0223C (previous) and 0526 (new)",
...
finalize(
    doc,
    '/app/work/output/_tmp_changes.docx',
    '/app/work/output/TMHCC_Media_Combined_Summary_of_Changes_FINAL.docx',
